...
public class LocationService extends Service {
    ...
    public void onStart(Intent intent, int startId) {
        ...
        //Toast.makeText(this, "Service Is Satrted", Toast.LENGTH_LONG).show();
    }
    ...
    public class MyLocationListener implements LocationListener
    {
        ...
        public void onLocationChanged(final Location loc)
        {
            ...
            if(isBetterLocation(loc, previousBestLocation)) {
                ...
                fillLocation.setLatitude(Latitude);
                fillLocation.setLongitude(Longitude);

                final ConnectionManager conn=new ConnectionManager();/*getApplicationContext());*/
